%% $Id: tabela-simbolos-doc.tex,v 1.6 2004/03/23 17:36:50 mvsfrasson Exp $
...
%%
%% $Log: tabela-simbolos-doc.tex,v $
%% Revision 1.6  2004/03/23 17:36:50  mvsfrasson
%%
%% Arquivos atualizados para nao dependerem do pacote html
%%
%% Revision 1.5  2003/03/28 20:54:56  gweber
%% ajustes nas citações às normas
%%
%% Revision 1.4  2003/03/19 21:05:14  gweber
%% Corrigida uma incompatibilidade com hyperref e consequentemente
%% com pdflatex. O estilo agora passa a opção hyperindex=false para
%% o hypereref.
%%
%%
...
\def\Versao$#1 #2${#2}
\def\Data$#1 #2 #3${#2}
\def\DataCVS{\Data$Date: 2004/03/23 17:36:50 $}
\def\VersaoCVS{\Versao$Revision: 1.6 $}
\begin{document}
...
Altere os textos prédefinidos através do comando \verb+\renewcommand+
\begin{verbatim}
...
\section{Alteraões mais sofisticadas}
