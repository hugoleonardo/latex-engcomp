...
% sinais dos coeficientes de acordo com a convenção do S-PLUS = -1*Matlab

% Determina Polinomio "Vphi(B)=phi(B)D(B)" de acordo com a 
% Eq. (16.26), pg. 475, do Livro "Análise de Séries Temporais", de 
% Morettin e Toloi, 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   References:
%    1) J.-A. Bäckar, "A Framework for Implementing Fractal Traffic Models 
%    in Real Time", M.Sc. Thesis, SERC, Melbourne,2000.
%    2) F. L. de Mello, "Estudo e Implementação de um Gerador de Tráfego 
%    com Dependência de Longa Duração", M.Sc. Thesis, Univ. of Sao Paulo, 2006.   
%    3) F. L. de Mello, A. B. de Lima, M. Lipas, J. R. A. Amazonas, 
%    "Geração de Séries Auto-Similares Gaussianas via Wavelets para Uso em 
%    Simulações de Tráfego", IEEE Latin America Transactions, Março, 2007.
