...
subplot(2,2,1),plot(intervalo_temp,v1),title('Sinal de saída do divisor de tensão'),xlabel('Temperatura'), ylabel('Volts');
subplot(2,2,2),plot(intervalo_temp,v0,'r'),title('Sinal de saída do circuito'),xlabel('Temperatura'), ylabel('Volts');
subplot(2,2,3),stairs(intervalo_temp,vetor_quantizado_converted,'g'),title('Sinal quantizado'),xlabel('Temperatura'),ylabel('Volts');
subplot(2,2,4),plot(vetor_amostras,intervalo_temp,'r');
