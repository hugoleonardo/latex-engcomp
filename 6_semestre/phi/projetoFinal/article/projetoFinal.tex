...
Esses gráficos foram gerados utilizando uma roda com raio $ \textit{r} = 0.05m $, tempo total da simulação $ T_{sim} = 20s $ e com velocidade real crescente inicial $ V_{inicial} = 1.01 m/s $ crescento em uma progrressão aritmética (PA) com razão de 0.01.
