...
\usepackage{cite}			% Inclusão de gráficos
% ---
...
\autor{ Universidade Federal do Pará \\
...
\local{Brasil}
\data{Belém, 13 de Novembro de 2014}
% ---
...
%		Teoria da COmputação II \linebreak
%		Avaliação 3 - Teoria da Intratabilidade \linebreak
%		Prof$^{o}$ Jamir}
...
Todas ou quase todas as pessoas que estudaram em algum momento teoria da complexidade já ouviram falar da Teoria da intratabilidade, mais especificamente do problema P \textit{versus} NP, só que normalmente este assunto não é apresentado de forma simplificada, exatamente por não ser um tema fácil de apresentar.
...
\subsection{A importância do problema}
