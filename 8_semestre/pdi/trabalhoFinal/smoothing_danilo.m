...
feature1 = normaliza(feature1, M, N);
feature2 = normaliza(feature2, M, N);
...
feature_s_norm = normaliza(feature_s, M, N);
...
imwrite(feature_s_norm_avg, 'mosaic3_window5_smoothed_homogeneity.png');
