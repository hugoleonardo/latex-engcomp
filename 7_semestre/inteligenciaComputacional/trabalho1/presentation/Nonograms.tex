...
\begin{frame}{Processo}
	\begin{itemize}
		\item Gera-se uma quantidade de indivíduos que se mantida de geração em geração
		\item As linhas são geradas de forma aleatória, porém os critérios das linhas serão sempre respeitados
	\end{itemize}
\end{frame}
...
\begin{frame}{Processo}
	\begin{itemize}
		...
		\item Há cruzamentos até que a próxima geração o mesmo número de indivíduos da geração atual
	\end{itemize}
\end{frame}
